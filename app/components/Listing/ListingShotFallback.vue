...
<template>
  <div class="relative flex size-full items-center justify-center overflow-hidden bg-[#111726] text-center">
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(99,102,241,0.24),transparent_34%),radial-gradient(circle_at_82%_76%,rgba(16,185,129,0.12),transparent_32%)]" />
    ...
    <div class="relative flex max-w-[80%] flex-col items-center gap-2.5">
      ...
      <span
        v-else
        class="flex size-11 items-center justify-center rounded-xl border border-brand-accent/35 bg-brand-accent/15 font-mono text-sm font-semibold tracking-wide text-brand-fg shadow-[0_10px_32px_rgba(0,0,0,0.28)]"
      >
        {{ mark }}
      </span>
      <div class="min-w-0">
